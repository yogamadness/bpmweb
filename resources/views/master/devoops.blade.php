...
<header class="navbar">
	<div class="container-fluid expanded-panel">
		<div class="row">
			<div id="logo" class="col-xs-12 col-sm-2" style="">
				<a href="">TAP</a> <!-- RIPUTRA ARGO PERSADA -->
			</div>
				...
				<div class="row">
					...
					<div class="col-xs-4 col-sm-8 top-panel-right">
						<ul class="nav navbar-nav pull-right panel-menu">
							<li class="hidden-xs">
								<a href="assets/devoops/ajax/page_messages.html" class="ajax-link">
							...
							<li class="dropdown">
								<a href="" class="dropdown-toggle account" data-toggle="dropdown">
									<div class="avatar">
										<img src="assets/devoops/img/avatar.jpg" class="img-rounded" alt="avatar" />
									</div>
									<i class="fa fa-angle-down pull-right"></i>
									<div class="user-mini pull-right">
										<span class="welcome">Welcome,</span>
										<span>Doni Romdoni</span>
									</div>
								</a>
	...
	<div class="row">
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				<li>
					<a href="" class="active ajax-link"> <!-- assets/devoops/ajax/dashboard.html -->
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-dashboard""></i>
						 <span class="hidden-xs">PTK</span>
					</a>
					<ul class="dropdown-menu">
						<li><a href="#">Estate Non Staff Panen</a></li>
						<li><a href="#">Estate Non Staff Rawat</a></li>
						<li>
