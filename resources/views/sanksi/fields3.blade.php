<div class="box-body">
			...
			<div class="form-group">
				<div class="col-md-6 md10">
					...
					<div class="input-group date">
						...
						<input type="text" class="form-control pull-right datepicker2" id="datepicker2" style="width: 100%;">
					</div>
				</div>
				<div class="col-md-6">
  ...
  <div class="panel panel-default">
		<div class="panel-body">
      <div class="form-group">
				<div class="col-md-12 md10">
					<label class="col-sm-2 control-label">Kepada :</label>
          <div class="col-sm-10">
            <div class="input-group">
                  <span class="input-group-addon">Bpk/Ibu</span>
                  <input type="text" class="form-control" placeholder="">
            </div>
          </div>
				</div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group">
                  <span class="input-group-addon">HC Director Region</span>
                  <input type="text" class="form-control" placeholder="">
            </div>
          </div>
				</div>
      ...
      <div class="form-group">
            ...
            <p>
              Dengan hormat,
              Menindaklanjuti Surat Panggilan I (Pertama) No <input type="text" class="" placeholder=""> tanggal <input type="text" class="" placeholder=""> dan Surat Panggilan II (Kedua) No <input type="text" class="" placeholder=""> tanggal <input type="text" class="" placeholder=""> , Saudara tidak memenuhi panggilan tersebut, maka dengan ini kami sampaikan bahwa sesuai dengan pasal <input type="text" class="" placeholder=""> Peraturan Perusahaan PT <input type="text" class="" placeholder=""> dan Pasal 168 Undang – Undang No. 13 tahun 2003 tentang Ketenagakerjaan, Saudara dikualifikasikan mengundurkan diri terhitung efektif hari <input type="text" class="" placeholder=""> , tanggal <input type="text" class="" placeholder="">
