<div class="box-body">
			...
			<div class="form-group">
				<div class="col-md-6 md10">
					...
					<div class="input-group date">
						...
						<input type="text" class="form-control pull-right datepicker2" style="width: 100%;">
					</div>
				</div>
				<div class="col-md-6">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="col-md-12">
				<label><h2>Jenis Pelanggaran</h2></label>
				<div class="row" id="offense">
					<div class="form-group clearfix" id="clones">
						<div class="col-xs-4 col-sm-3">
							<select class="form-control select2 offense" style="width: 100%;">
								<option></option>
						...
						<div class="col-xs-2 col-sm-1">
							<a class="btn btn-danger btn-remove"><i class="fa fa-minus-circle"></i></a>
						</div>
					</div>
				</div>
				<a href="#" id="replicate" class="btn btn-default"><i class="fa fa-plus-circle"></i> Tambah Jenis Pelanggaran</a>
			</div>
		</div>
	</div>
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="col-md-12">
				<label><h2>Komentar Atasan</h2></label>
				<div class="form-group">
					<textarea class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
				</div>
			</div>
